                            ...
                            <tbody>
                                @foreach ($vendas as $venda)
                                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <th scope="row">
                                        <button onclick="preencherModal({{$venda}})" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button" data-modal-toggle="defaultModal">
                                            Toggle modal
                                          </button>
                                        </th>
                                    </tr>
